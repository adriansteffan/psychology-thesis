...
The graph suggests that a timestamp recorded by the two gaze coders likely does not refer to the same time points in real-world time, suggesting they are about one second apart. We discuss this offset further in the Limitations section.
